...
<%
    ...
    try{
        ...
        String sql= "update purchase set Date = ?, Name = ?, Description = ?, Rate = ?, Qty = ?, Amount = ?, VAT = ?, Discount = ?, Total_Amount = ? where Pid = "+a;
        ...
        {
            RequestDispatcher rd = request.getRequestDispatcher("UpdatePurchase.jsp");
            rd.forward(request, response);}
        }
