...
<html>
	...
	<body>
        ...
        <div class = "container">
                <h1>Sales Update</h1>
            <form action = "UpdateSalesJsp.jsp" method = "post">
                <%
                    try{
                    st = con.createStatement();
                    String up = request.getParameter("u");
                    int num = Integer.parseInt(up);
                    String data = "select *from Sales where Sno = '"+num+"'";
                ...
                <p>Amount</p><input type="text" name="amount" maxlength="0" value="<%=rs.getString(7)%>"required>

                <p>VAT</p><input type="text" name="vat" value="<%=rs.getString(8)%>" required/>

                <p>Discount</p><input type="text" name="discount" value="<%=rs.getString(9)%>" onchange="show(this)" required/>

                <p>Total Amount</p><input type="text" name="total" maxlength="0" value="<%=rs.getString(10)%>" required > 
                <%
                break;
                    }
                    } catch (Exception e) {
