...
<html>
	...
	<body>
        ...
        <div class = "container">
            ...
            <form action = "UpdateCustomerJsp.jsp" method = "post">
                <%
                    try{
                    st = con.createStatement();
                    String up = request.getParameter("u");
                    int num = Integer.parseInt(up);
                    String data = "select *from customer where Cid = '"+num+"'";
                ...
                <p>Phone Number</p><input type = "text" name = "contact" value = "<%=rs.getString(6)%>" required/>

                <p>Email</p><input type = "text" name = "email" value = "<%=rs.getString(7)%>" required/>
