            ...
            <table border = "2" width = "900">
                ...
                <%
                    try{
                        ...
                        String data;
                        if(query!=null){
                            data = "select *from sales where Date like '%"+query+"%' or Name like '%"+query+"%' or Description like '%"+query+"%' or Rate like '%"+query+"%' or Qty like '%"+query+"%' or Amount like '%"+query+"%' or VAT like '%"+query+"%' or Discount like '%"+query+"%' or Total_amount like '%"+query+"%' ";
                        }else{
                            data = "select *from sales order by Sno desc";
                        }
                ...
                <tr>
                    ...
                    <td class = "text-center">
                        <a href="UpdateSales.jsp?u=<%=rs.getString(1)%>">Update</a>
                        <a href="DeleteSales.jsp?u=<%=rs.getString(1)%>">Delete</a>
                    </td>
                </tr>
                <%
                    }
