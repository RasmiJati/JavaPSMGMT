            ...
            <tr id = "theader">
                ...
                <%
                    try{
                        ...
                        String data;
                        if(query!=null){
                            data = "select *from customer where Name like '%"+query+"%' or Address like '%"+query+"%' or Date like '%"+query+"%' or Gender like '%"+query+"%' or Email like '%"+query+"%' or Phone_no like '%"+query+"%'";
                        }else{
                            data = "select *from customer order by Cid desc";
                        }
